...
game.state.add('state1', {preload: preload, create: create, update: update});
function preload() {
	game.load.image('star', star_img);
	game.load.image('space', background);
}

var distance = 300;
var speed = 4;
var stars;
var star_img= 'assets/star.png';
var background= 'assets/space.jpeg';
var max = 70;
var xx = [];
var yy = [];
var zz = [];
